  ...
  return (
    <div>
      ...
      <table>
        ...
        <tbody>
          {sortedCustomers.slice(indexOfFirstItem, indexOfLastItem).map((customer, index) => (
            <tr key={index}>
      ...
      <div className="pagination">
        ...
        <button onClick={nextPage} disabled={indexOfLastItem >= sortedCustomers.length}>Next</button>
      </div>
    </div>
  );
};
